...
function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground border-t border-primary-foreground/10 mt-auto">
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://www.facebook.com/patel.pranshu.350/" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full transition-colors group">
              ...
              <a href="https://www.instagram.com/patelpranshu_/" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full transition-colors group">
              ...
              <a href="https://twitter.com/patelpranshu_" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full transition-colors group">
              ...
              <a href="https://www.youtube.com/@patelpranshu_" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full transition-colors group">
            ...
            <ul className="space-y-4 text-sm text-primary-foreground/70">
              <li>
                <Link to="/shop/listing" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Our Services
                </Link>
              </li>
              <li>
                <Link to="/shop/privacy-policy" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/shop/terms-conditions" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Terms &amp; Conditions
                </Link>
              </li>
              <li>
                <a href="#aboutus" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> About Us
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4 text-sm text-primary-foreground/70">
              <li>
                <a href="#contact" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Warranty Information
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Troubleshoot
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Where To Buy
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:text-white transition-colors flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary-foreground/40 mr-2"></span> Bulk Orders
                </a>
              </li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-primary-foreground/10 mt-12 pt-8 text-sm text-primary-foreground/50">
